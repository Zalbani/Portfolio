        ...
        <div className="flex items-center gap-2 flex-wrap">
          {socialLinks.map((s) => (
            <a
              ...
              aria-label={t(s.key)}
              className="w-9 h-9 glass rounded-xl flex items-center justify-center text-ink-secondary dark:text-slate-400 hover:text-terra-600 dark:hover:text-[#00ADB5] hover:bg-pastel-terra/30 dark:hover:bg-[#00ADB5]/10 transition-all duration-200"
            >
              {s.icon}
            </a>
          ))}
