...
export function About() {
  ...
  return (
    <section
      id="about"
      className="flex flex-col min-h-[calc(100vh-4.5rem)] lg:min-h-screen justify-between lg:justify-center py-14 lg:py-24"
    >
      ...
      <div className="lg:hidden flex flex-col gap-3 pt-6 pb-2">
